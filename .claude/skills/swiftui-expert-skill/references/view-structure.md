...
The initializer with @ViewBuilder parameter that accepts the closure
How the closure is evaluated once during initialization
Why the stored Content view maintains stable identity for diffing
